...
import { FolderOpen, Moon, Plus, Server, Sun } from 'lucide-react'
...
export function App() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      <PageHeader
        title={APP_NAME}
        description={`${APP_TAGLINE} — página de estilo (Fase 0)`}
        actions={
          <Button variant="secondary" size="sm" onClick={toggleTema}>
            {dark ? <Sun /> : <Moon />}
            {dark ? 'Claro' : 'Escuro'}
          </Button>
        }
        ...
        <Secao titulo="Tipografia">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[16px] text-ink">
              Inter 16 — corpo do produto, formulários e tabelas.
            </p>
